package com.dic.form.service.imp.letter.clue;
...
import com.dic.form.db.mapper.primary.letter.*;
import com.dic.form.db.mapper.primary.letter.casemanage.LetClueCreatorMapper;
import com.dic.form.db.mapper.primary.letter.clue.*;
import com.dic.form.models.dto.LetFileResDTO;
import com.dic.form.models.dto.letter.clue.*;
import com.dic.form.service.interf.StuffService;
import com.dic.form.service.interf.letter.clue.LetClueService;
import com.dic.form.utils.LetClueIdBuilder;
...
public class LetClueImp extends ServiceImpl<LetClueMapper, LetClue> implements LetClueService {
    ...
    public LetClueResDTO selectOne(String letClueId) throws UnsupportedEncodingException {
        ...
        //查询扫描件
        List<LetFileResDTO> letFileResDTOList = stuffService.findStuffList(letClueId, EnumStuffRelationType.XianSuo);
...
//            letClueSourceMapper.insertLetClueSources(letClueSourceList);
        ...
        //添加/更新 文件
        Boolean insertStuffToDBResult = stuffService.insertStuffToDB(letClueUpdateDTO.getFileList(), letClueId, EnumStuffRelationType.XianSuo, isCreate);
