...
import com.dic.socketio.model.MessageModel;
...
//        String userId=client.getHandshakeData().getHttpHeaders().get("Authorization");
    ...
    //用户列表维护方法
    //在线用户信息更新
    private void addUserInfo(AuthDTO authDTO, UUID uuid) {
        String userId = String.valueOf(authDTO.getId());
        String userNickname = authDTO.getNickname();
        //更新UUIDUserIdMap
