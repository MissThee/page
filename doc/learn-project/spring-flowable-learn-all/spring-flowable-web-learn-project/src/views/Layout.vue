<template>
  <div style="position: absolute;height: 100%;width: 100%;">
    <el-container>
      ...
      <div style="position:absolute;top:50px;left:0;bottom: 0;overflow-x: hidden;width:180px;background-color: rgb(84, 92, 100)">
        <Sidebar></Sidebar>
      </div>
      <div style="position:absolute;top:50px;left:180px;right:0;height: 30px">
        <TagsBar ref="tabs"></TagsBar>
      </div>
