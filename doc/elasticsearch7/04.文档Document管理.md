...
1. 请求体格式。（注意结尾行最后也要有换行符）
   ...
   + POST /{Index}/{Type}/_bulk
     ...
     {"id": 7,"title": "bulk测试1","content": "能批量新增了！！使用的不是智能划分","content1":"能批量新增了！这个分词使用的不是最细划分","english_text":"this is a test sentence. apple is a company.","date_value":"2019-01-01"}
     {"index": {}}
     {"id": 8,"title": "bulk测试2","content": "批量再加一条数据，使用的最细划分","content1": "批量再加一条数据，分词使用的是智能划分","english_text":"there is no spoon. apple is red. apple pie tastes delicious.","date_value":"2019-01-02"}
     {"create": {"_id": 9}}
